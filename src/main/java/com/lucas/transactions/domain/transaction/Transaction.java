...
public class Transaction {
    ...
    public double applyAmountToAggregatedValue(Amount creditLimitAggregatedValue) {

        return this.amount.getValueNumber() + (creditLimitAggregatedValue.getValueNumber() * -1);
    }
}
